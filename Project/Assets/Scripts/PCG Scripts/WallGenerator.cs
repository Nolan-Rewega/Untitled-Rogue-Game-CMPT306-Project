...
public static class WallGenerator {
    public static void CreateWalls(HashSet<Vector2Int> floorPositions, TileMapVisualizer tilemapVisualizer) {
        ...
        CreateDoors(tilemapVisualizer, floorPositions);
    }

    private static void CreateDoors(TileMapVisualizer tilemapVisualizer, HashSet<Vector2Int> floorPositions) {
        foreach (var position in floorPositions) {
            ...
            // tilemapVisualizer.PaintSingleDoor(position, neighboursBinaryType);
        }
    }
